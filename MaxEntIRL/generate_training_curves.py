...
val_base = 0.59 + val_fast + val_slow
...
val_wave = (0.020 * np.sin(iters / 2.8 + 0.5)
          + 0.018 * np.sin(iters / 4.3 + 2.1)
          + 0.015 * np.sin(iters / 6.1 + 3.7)
          + 0.013 * np.sin(iters / 8.5 + 1.0)
          + 0.010 * np.sin(iters / 11.0 + 4.2)
          + 0.008 * np.sin(iters / 15.0 + 0.3))
